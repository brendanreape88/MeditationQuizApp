...
const STORE = [
  {
    question:
      "Meditation is generally considered to be which of the following?",
    answers: [
    ...
    correctAnswer: "(A) A mental technique done sitting, with eyes closed.",
  ...
  },
  {
    ...
    correctAnswer: "(A) 5000 BCE in India",
  ...
  },
  {
    ...
    correctAnswer: "(B) 200 - 500 million",
  ...
  {
    question:
      "In the United States, the most common reason people learn to meditate is:",
    answers: [
    ...
    correctAnswer: "(D) To reduce stress",
  ...
  },
  {
    ...
    correctAnswer: "(A) Focused attention, open monitoring",
  ...
  },
  {
    ...
    correctAnswer: "(D) neuroplasticity",
  ...
  {
    question:
      "Research on in-school meditation programs has shown that participating students benefit in which of the following ways?",
    answers: [
